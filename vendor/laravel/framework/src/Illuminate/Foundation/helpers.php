...
if(! function_exists('api_json')){
	...
	function api_json( $data = array() , $code = "", $msg = '')
    {
...
if(! function_exists('sign')){
    ...
    function sign($arr){
        ksort($arr);
        $arr['PostKey'] = 'BCF319B377825C157A9EDBD9240BB90E';
...
if(! function_exists('rules_phone')){
     ...
     * 2018-12-29
     */
    function rules_phone($phone){

        $rules = '/^1[3456789][0-9]{9}$/';
        if(preg_match($rules, $phone)){
            return true;
        }else{
            return false;
        }
...
if(! function_exists('curlMet')){

    /**
     *post 提交
     */
    function curlMet($url,$method,$post_data = 0)
    {
        $ch = curl_init();
